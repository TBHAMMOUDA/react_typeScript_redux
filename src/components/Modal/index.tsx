...
export default class Modal extends React.Component<IPropos, IState> {
    render() {
        return <div className='modal fade' id={this.props.id}>
            <div className='modal-dialog modal-dialog-centered'>
                <div className='modal-content'>
                    ...
                    <div className='modal-footer'>
                        ...
                        {this.props.title !== 'Coming Soon' && <Button size='large' content={this.props.actionContent} theme={this.props.actionTheme || 'primary'} action={this.props.actionCallback} disabled={this.props.valid} />}
                    </div>
                </div>
            </div>
        </div>
